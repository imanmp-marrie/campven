...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final List<String> _filters = ['All Results', 'This Week', 'On Campus', 'Academic'];
  ...
  List<EventModel> _getFilteredEvents(List<EventModel> events) {
    ...
    return events.where((e) =>
        ...
        e.location.toLowerCase().contains(_query.toLowerCase())).toList();
  }
          ...
          Expanded(
            child: Consumer<EventProvider>(
              builder: (context, provider, _) {
                final results = _getFilteredEvents(provider.events);
                if (_query.isEmpty) {
                  return const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 12),
                        Text('Cari event kampus...', style: TextStyle(color: Colors.grey)),
                      ],
                    ),
                  );
                }
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    ...results.map((event) => _buildSearchCard(context, event)),
                  ],
                );
              },
            ),
