...
class _SettingsScreenState extends State<SettingsScreen> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Manage your account and app preferences',
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Text('Campven',
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                  const Text('Version 2.4.0 (Academic Build)',
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.email_outlined, color: Color(0xFF1A6BFF), size: 20),
                      ),
                      const SizedBox(width: 12),
                      const Expanded(child: Text('Support & Contact',
        ...
        child: Row(
          children: [
            Container(
              padding: const EdgeInsets.all(8),
              decoration: BoxDecoration(
                  color: const Color(0xFFEEF3FF), borderRadius: BorderRadius.circular(8)),
  ...
  Widget _buildToggleItem({required IconData icon, required String label,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Switch(value: value, onChanged: onChanged, activeColor: const Color(0xFF1A6BFF)),
        ],
      ),
    );
  }
